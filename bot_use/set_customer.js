...
const passS = "Est1540+*#"
const { UFA66_CUSTOMER } = require('./data_set_customer')
...
(async () => {
    ...
    for (const [idx, data] of UFA66_CUSTOMER.entries()) {
        console.log(idx, " data.username : ", data.username, " data.agent : ", data.agent, " checkPosition : ", checkPosition);
        if (data.WEB === '66') { checkPass = passA_66 } else if (data.WEB === 'PSD') { checkPass = passA_PSD } else if (data.WEB === 'TOP') { checkPass = passA_TOP }
        if (checkPosition !== data.agent) {
            console.log(checkPosition !== data.agent);
            ...
            await element[0].type(checkPass);
        ...
        // OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRAS',this,'btnUpdRAS')"]`);
        element = await page.$x(`//*[@id="btnUpdRAS"]`)
        await element[0].click();
        await page.waitForNavigation({ waitUntil: 'load' })
        await delay(1000);
        //  ITP (UPG/MG)
        ...
        // OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRCV',this,'btnUpdRCV')"]`);
        element = await page.$x(`//*[@id="btnUpdRCV"]`)
        await element[0].click();
        await page.waitForNavigation({ waitUntil: 'load' })
        await delay(1000);
        //  JOKER
        ...
        // OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRAU',this,'btnUpdRAU')"]`);
        element = await page.$x(`//*[@id="btnUpdRAU"]`)
        await element[0].click();
        await page.waitForNavigation({ waitUntil: 'load' })
        await delay(1000);
        ...
        // OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRCZ',this,'btnUpdRCZ')"]`);
        element = await page.$x(`//*[@id="btnUpdRCZ"]`)
        await element[0].click();
        await page.waitForNavigation({ waitUntil: 'load' })
        await delay(1000);
        ...
        // OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRBH',this,'btnUpdRBH')"]`);
        element = await page.$x(`//*[@id="btnUpdRBH"]`)
        ...
        // OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRBI',this,'btnUpdRBI')"]`);
        element = await page.$x(`//*[@id="btnUpdRBI"]`)
        ...
        //  OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRBL',this,'btnUpdRBL')"]`);
        element = await page.$x(`//*[@id="btnUpdRBL"]`)
        ...
        // OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRCW',this,'btnUpdRCW')"]`);
        element = await page.$x(`//*[@id="btnUpdRCW"]`)
        ...
        // OFF
        // element = await page.$x(`//table[@onclick="toggleSetting2('trRCX',this,'btnUpdRCX')"]`);
        element = await page.$x(`//*[@id="btnUpdRCX"]`)
        await element[0].click();
        await page.waitForNavigation({ waitUntil: 'load' })
