        ...
        if (i > 0) {
            paginationItems.push(
                <li key={'page-' + i} onClick={() => handleChange('page', i)}>
                    <a href="#"
                        className={`flex items-center justify-center p-1 md:px-3 h-8 leading-tight border ${page === i
    ...
    return (
        <nav className="relative flex items-center flex-column flex-wrap md:flex-row justify-between" aria-label="Table navigation">
            ...
            <ul className="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
                <li>
                    <a href="#" onClick={() => page > 1 && handleChange('page', 1)} className="flex items-center justify-center px-1 md:px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                        <FaAngleDoubleLeft />
                    </a>
                </li>
                <li>
                    <a href="#" onClick={() => page > 1 && handleChange('page', page - 1)} className="flex items-center justify-center px-1 md:px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                        <FaArrowLeft />
                    </a>
                </li>
                {paginationItems}
