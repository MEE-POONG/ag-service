...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ReactIconComponent icon="FaChevronDown" setClass="relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180" />
  </NavigationMenuPrimitive.Trigger>
))
...
>(({ className, ...props }, ref) => (
  ...
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-border shadow-md">
      <ReactIconComponent icon="FaChevronDown" setClass="h-2 w-2 rotate-45 rounded-tl-sm bg-border shadow-md" />
    </div>
  </NavigationMenuPrimitive.Indicator>
))
