      ...
      <div className="p-3 sm:p-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 m-2 sm:mb-4">
            ...
            <button className="px-3 py-2 sm:px-4 sm:py-2 text-sm sm:text-base bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors">
              + เพิ่มผู้ดูแล
            </button>
          </div>
          
          <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-3 sm:mb-4">รายการผู้ดูแลระบบ</h2>
