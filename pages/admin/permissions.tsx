...
export default function PermissionsPage() {
  ...
  return (
    <TheLayout>
      <div className="bg-white shadow-sm rounded-lg pl-1 sm:p-2">
          ...
          <Dialog as="div" className="relative z-50" onClose={() => { setShowForm(false); setEditId(null); }}>
            ...
            <div className="fixed inset-0 z-50 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-2 sm:p-4 text-center">
                ...
                >
                  <Dialog.Panel className="w-full max-w-sm sm:max-w-2xl transform overflow-hidden rounded-2xl bg-white pl-1 sm:p-2 text-left align-middle shadow-xl transition-all">
