curl --location --transaction POST 'http://157.230.45.203:9000/api/endpoints/2/docker/images/create?fromImage=chunwarayut%2Fagservice:latest' \
...
--data-raw '{
    "fromImage": "chunwarayut/agservice:latest"
}'
