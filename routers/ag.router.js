...
// router.get('/', agController.agList)
// router.get('/:id', agController.agDetail)
// router.post('/search', agController.agSearch)
// router.post('/', agController.agStore)
// router.put('/:id', agController.agUpdate)
// router.delete('/:id', agController.agDelete)
