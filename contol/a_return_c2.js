...
const userUfrcb = "ufrcbvip"
const userUfrce = "ufrcevip"
const userUfh27 = "ufh27vipp"
const userUfruu = "ufruuvip"
const userUfruv = "ufruvvip"
const userA = "ufrcba1"
...
(async () => {
	...
	await delay(1000);
  // /_Part_Sub/SubAccsWinLose2.aspx?role=sa&userName=ufh27oa1&from=02/01/2022&to=02/28/2022&userID=ufh27o&checkAll=False
	await page.goto(agtest + `/_Part_Sub/SubAccsWinLose2.aspx?role=sa&userName=` + userA + `&from=02/01/2022&to=02/28/2022&catId=&gId=-1&checkAll=True`, {
